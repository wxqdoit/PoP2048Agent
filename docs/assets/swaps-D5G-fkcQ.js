import{B as e,H as t,N as n,S as r,b as i,h as a,r as o,st as s,v as c}from"./ApiController-DpO-Sb7-.js";import{S as l,b as u,d,g as f,l as p,m,o as h,v as g,y as _}from"./wui-text-1tMU42WY.js";import{t as v}from"./SwapController-CUgQxH2s.js";import"./w3m-tooltip-zkjhpZED.js";import"./wui-button-BB24Ltwk.js";import"./wui-icon-BGQyA6ab.js";import"./wui-image-CfOyn9NQ.js";import"./wui-shimmer-DXkfHglT.js";import"./wui-shimmer-RD32hpsz.js";import"./wui-icon-box-DYmTWLAy.js";import"./wui-input-text-CjbKSRAM.js";import"./wui-token-button-Bj6DoB0_.js";var y={numericInputKeyDown(e,t,n){let r=[`Backspace`,`Meta`,`Ctrl`,`a`,`A`,`c`,`C`,`x`,`X`,`v`,`V`,`ArrowLeft`,`ArrowRight`,`Tab`],i=e.metaKey||e.ctrlKey,a=e.key,o=a.toLocaleLowerCase(),s=o===`a`,c=o===`c`,l=o===`v`,u=o===`x`,d=a===`,`,f=a===`.`,p=a>=`0`&&a<=`9`;!i&&(s||c||l||u)&&e.preventDefault(),t===`0`&&!d&&!f&&a===`0`&&e.preventDefault(),t===`0`&&p&&(n(a),e.preventDefault()),(d||f)&&(t||(n(`0.`),e.preventDefault()),(t?.includes(`.`)||t?.includes(`,`))&&e.preventDefault()),!p&&!r.includes(a)&&!f&&!d&&e.preventDefault()}},b=m`
  :host {
    width: 100%;
  }
