import{G as e,K as t,L as n,S as r,Y as i,v as a}from"./ApiController-DpO-Sb7-.js";import{S as o,T as s,b as c,m as l,o as u,v as d,y as f}from"./wui-text-1tMU42WY.js";import"./wui-icon-BGQyA6ab.js";var p=t({message:``,open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:`shade`}),m=n({state:p,subscribe(e){return i(p,()=>e(p))},subscribeKey(t,n){return e(p,t,n)},showTooltip({message:e,triggerRect:t,variant:n}){p.open=!0,p.message=e,p.triggerRect=t,p.variant=n},hide(){p.open=!1,p.message=``,p.triggerRect={width:0,height:0,top:0,left:0}}}),h=s`
  :host {
    width: 100%;
    display: block;
  }
