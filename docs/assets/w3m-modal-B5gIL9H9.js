import{E as e,F as t,P as n,R as r,S as i,_ as a,b as o,g as s,l as c,r as l,s as u,t as d,v as f}from"./ApiController-DWdvrTpZ.js";import{S as p,T as ee,_ as m,b as h,c as g,d as _,h as v,l as te,m as y,o as b,u as ne,v as x,y as S}from"./wui-text-CWDibTRZ.js";import{r as C}from"./wui-list-wallet-D_5AMGwJ.js";import{t as re}from"./SwapController-BuLECivp.js";import{t as w}from"./AlertController-BtrGf2r_.js";import"./w3m-tooltip-Bu3XxxgG.js";import"./wui-loading-spinner-CuLGy6vC.js";import"./wui-button-BGAEcWpk.js";import"./wui-icon-DPhMrpvH.js";import{n as T}from"./exports-Dqidr8tg.js";import"./wui-image-CrtK0GFx.js";import"./wui-icon-box-BHv7evaA.js";import{t as E}from"./HelpersUtil-BtV5tUMs.js";import{t as D}from"./ConstantsUtil-C1qdKpER.js";var O={isUnsupportedChainView(){return i.state.view===`UnsupportedChain`||i.state.view===`SwitchNetwork`&&i.state.history.includes(`UnsupportedChain`)},async safeClose(){if(this.isUnsupportedChainView()){f.shake();return}if(await C.isSIWXCloseDisabled()){f.shake();return}(i.state.view===`DataCapture`||i.state.view===`DataCaptureOtpConfirm`)&&c.disconnect(),f.close()}},ie=y`
  :host {
    display: block;
