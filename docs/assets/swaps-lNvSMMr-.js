import{B as e,H as t,N as n,S as r,b as i,h as a,r as o,st as s,v as c}from"./ApiController-DWdvrTpZ.js";import{S as l,b as u,d,g as f,l as p,m,o as h,v as g,y as _}from"./wui-text-CWDibTRZ.js";import{t as v}from"./SwapController-BuLECivp.js";import"./w3m-tooltip-Bu3XxxgG.js";import"./wui-button-BGAEcWpk.js";import"./wui-icon-DPhMrpvH.js";import"./wui-image-CrtK0GFx.js";import"./wui-shimmer-D68yqmfq.js";import"./wui-shimmer-CHpCIxB-.js";import"./wui-icon-box-B5MJ7M06.js";import"./wui-input-text-CJ95q_ho.js";import"./wui-token-button-CtDnxRXW.js";var y={numericInputKeyDown(e,t,n){let r=[`Backspace`,`Meta`,`Ctrl`,`a`,`A`,`c`,`C`,`x`,`X`,`v`,`V`,`ArrowLeft`,`ArrowRight`,`Tab`],i=e.metaKey||e.ctrlKey,a=e.key,o=a.toLocaleLowerCase(),s=o===`a`,c=o===`c`,l=o===`v`,u=o===`x`,d=a===`,`,f=a===`.`,p=a>=`0`&&a<=`9`;!i&&(s||c||l||u)&&e.preventDefault(),t===`0`&&!d&&!f&&a===`0`&&e.preventDefault(),t===`0`&&p&&(n(a),e.preventDefault()),(d||f)&&(t||(n(`0.`),e.preventDefault()),(t?.includes(`.`)||t?.includes(`,`))&&e.preventDefault()),!p&&!r.includes(a)&&!f&&!d&&e.preventDefault()}},b=m`
  :host {
    width: 100%;
  }
...
`,x=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},S=t.CONVERT_SLIPPAGE_TOLERANCE,C=class extends u{constructor(){super(),this.unsubscribe=[],this.networkName=o.state.activeCaipNetwork?.name,this.detailsOpen=!1,this.sourceToken=v.state.sourceToken,this.toToken=v.state.toToken,this.toTokenAmount=v.state.toTokenAmount,this.sourceTokenPriceInUSD=v.state.sourceTokenPriceInUSD,this.toTokenPriceInUSD=v.state.toTokenPriceInUSD,this.priceImpact=v.state.priceImpact,this.maxSlippage=v.state.maxSlippage,this.networkTokenSymbol=v.state.networkTokenSymbol,this.inputError=v.state.inputError,this.unsubscribe.push(v.subscribe(e=>{this.sourceToken=e.sourceToken,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.priceImpact=e.priceImpact,this.maxSlippage=e.maxSlippage,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError}))}render(){let e=this.toTokenAmount&&this.maxSlippage?s.bigNumber(this.toTokenAmount).minus(this.maxSlippage).toString():null;if(!this.sourceToken||!this.toToken||this.inputError)return null;let t=this.sourceTokenPriceInUSD&&this.toTokenPriceInUSD?1/this.toTokenPriceInUSD*this.sourceTokenPriceInUSD:0;return l`
...
`,O=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},k=5e-5,A=class extends u{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target=`sourceToken`,this.onSetAmount=null,this.onSetMaxValue=null,this.autoFocus=!1}firstUpdated(){this.autoFocus&&requestAnimationFrame(()=>{(this.shadowRoot?.querySelector(`input`))?.focus()})}render(){let e=this.marketValue||`0`,t=s.bigNumber(e).gt(`0`);return l`
    ...
    `:l` <wui-button
      ...
      >
        Select token
      </wui-button>`}tokenBalanceTemplate(){let e=s.multiply(this.balance,this.price),t=e?e?.gt(k):!1;return l`
...
`,M=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},N=class extends u{subscribe({resetSwapState:e,initializeSwapState:t}){return()=>{o.subscribeKey(`activeCaipNetwork`,n=>this.onCaipNetworkChange({newCaipNetwork:n,resetSwapState:e,initializeSwapState:t})),o.subscribeChainProp(`accountState`,n=>{this.onCaipAddressChange({newCaipAddress:n?.caipAddress,resetSwapState:e,initializeSwapState:t})})}}constructor(){super(),this.unsubscribe=[],this.initialParams=r.state.data?.swap,this.detailsOpen=!1,this.caipAddress=o.getAccountData()?.caipAddress,this.caipNetworkId=o.state.activeCaipNetwork?.caipNetworkId,this.initialized=v.state.initialized,this.loadingQuote=v.state.loadingQuote,this.loadingPrices=v.state.loadingPrices,this.loadingTransaction=v.state.loadingTransaction,this.sourceToken=v.state.sourceToken,this.sourceTokenAmount=v.state.sourceTokenAmount,this.sourceTokenPriceInUSD=v.state.sourceTokenPriceInUSD,this.toToken=v.state.toToken,this.toTokenAmount=v.state.toTokenAmount,this.toTokenPriceInUSD=v.state.toTokenPriceInUSD,this.inputError=v.state.inputError,this.fetchError=v.state.fetchError,this.lastTokenPriceUpdate=0,this.minTokenPriceUpdateInterval=1e4,this.visibilityChangeHandler=()=>{document?.hidden?(clearInterval(this.interval),this.interval=void 0):this.startTokenPriceInterval()},this.startTokenPriceInterval=()=>{this.interval&&Date.now()-this.lastTokenPriceUpdate<this.minTokenPriceUpdateInterval||(this.lastTokenPriceUpdate&&Date.now()-this.lastTokenPriceUpdate>this.minTokenPriceUpdateInterval&&this.fetchTokensAndValues(),clearInterval(this.interval),this.interval=setInterval(()=>{this.fetchTokensAndValues()},this.minTokenPriceUpdateInterval))},this.watchTokensAndValues=()=>{!this.sourceToken||!this.toToken||(this.subscribeToVisibilityChange(),this.startTokenPriceInterval())},this.onDebouncedGetSwapCalldata=e.debounce(async()=>{await v.swapTokens()},200),this.subscribe({resetSwapState:!0,initializeSwapState:!1})(),this.unsubscribe.push(this.subscribe({resetSwapState:!1,initializeSwapState:!0}),c.subscribeKey(`open`,e=>{e||v.resetState()}),r.subscribeKey(`view`,e=>{e.includes(`Swap`)||v.resetValues()}),v.subscribe(e=>{this.initialized=e.initialized,this.loadingQuote=e.loadingQuote,this.loadingPrices=e.loadingPrices,this.loadingTransaction=e.loadingTransaction,this.sourceToken=e.sourceToken,this.sourceTokenAmount=e.sourceTokenAmount,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError,this.fetchError=e.fetchError,e.sourceToken&&e.toToken&&this.watchTokensAndValues()}))}async firstUpdated(){v.initializeState(),this.watchTokensAndValues(),await this.handleSwapParameters()}disconnectedCallback(){this.unsubscribe.forEach(e=>e?.()),clearInterval(this.interval),document?.removeEventListener(`visibilitychange`,this.visibilityChangeHandler)}render(){return l`
    ...
    `}templateTokenInput(e,t){let n=v.state.myTokensWithBalance?.find(e=>e?.address===t?.address),r=e===`toToken`?this.toTokenAmount:this.sourceTokenAmount,i=e===`toToken`?this.toTokenPriceInUSD:this.sourceTokenPriceInUSD,a=s.parseLocalStringToNumber(r)*i;return l`<w3m-swap-input
