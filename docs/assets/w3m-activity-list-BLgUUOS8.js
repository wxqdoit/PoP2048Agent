import{B as e,N as t,R as n,S as r,b as i,h as a,r as o,u as s}from"./ApiController-DpO-Sb7-.js";import{E as c,S as l,_ as u,b as d,d as f,m as p,o as m,s as h,v as g,y as _}from"./wui-text-1tMU42WY.js";import"./wui-image-CfOyn9NQ.js";import"./wui-icon-box-BPHjXrIC.js";import"./wui-shimmer-DXkfHglT.js";import"./wui-link-C49_4R0c.js";import"./wui-icon-box-DYmTWLAy.js";var v;(function(e){e.approve=`approved`,e.bought=`bought`,e.borrow=`borrowed`,e.burn=`burnt`,e.cancel=`canceled`,e.claim=`claimed`,e.deploy=`deployed`,e.deposit=`deposited`,e.execute=`executed`,e.mint=`minted`,e.receive=`received`,e.repay=`repaid`,e.send=`sent`,e.sell=`sold`,e.stake=`staked`,e.trade=`swapped`,e.unstake=`unstaked`,e.withdraw=`withdrawn`})(v||={});var y=p`
  :host > wui-flex {
    display: flex;
